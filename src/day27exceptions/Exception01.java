...
public class Exception01 {
	...
	public static void main(String[] args) {
		...
		String s3="Aliye Can";
		String t3="";
		divideLengths(s3,t3);//ArithmeticException
		
		String s4=null;
		String t4="Ali";
		divideLengths(s4,t4);//NullPointerException, if you use length() with "null" object, then you get this exception
		
		String s5="Aliye Can";
		String t5="Ali";
		divideLengths(s5.substring(9),t5);
	
		
		String s6="Aliye Canan";
		String t6="Ali";
		divideLengths(s6,t6);//StringIndexOutOfBoundsException
	}
	...
	public static void divideLengths4(String s, String t) {
		...
		result=s.length()/t.length();
			...
			System.out.println("by zero: "+e.getMessage());
