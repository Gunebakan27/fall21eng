...
Create a Custom Exception “IllegalPointException” which will be thrown if point is less than 0 or greater than 100.
 */
	...
	public static void checkPoint(int point) throws IllegalPointException {
		if(point<0||point>100) {
			throw new IllegalPointException(point+" is not between 0 and 100");
