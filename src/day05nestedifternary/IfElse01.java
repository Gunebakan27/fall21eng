...
//	if the year is divisible by 100 then it must be divisible by 400 ===> 1600 is leap, but 1700is not
//	If a year is not divisible by 100 then it must be divisible by 4 ===> 2004 is leap year, but 2007 is not
	/*
	 ...
	 Note:"&" and "&&" do the same. But "&&" doesn't check the second condition, 
	 		if the first condition is false.
	 		"&" checks both conditions everytime.
	 				
	 || means "or": If you  use "||" between 2 things, it means at least one of them is enough for you.
	 				"tea || coffee" means just "tea or just "coffee" or "both"
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter a year to learn if it is a leap year or not...");
